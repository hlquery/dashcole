...
const configuredApiUrl = stripTrailingSlash(import.meta.env.VITE_API_URL || (import.meta.env.PROD ? 'https://api.hlquery.com' : 'http://localhost:7000'))
...
export const trackDocsVisit = (route, referrer = document.referrer) => {
